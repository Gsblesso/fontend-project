...
export default function App() {
  ...
  const getResultMessage = (score: number) => {
    ...
    return "Don’t give up! You’ll improve!!";
  };
    ...
    >
      ...
      >
        ...
        >
          {/* Brain Icon */}
<div
  className="absolute left-6 bottom-6 text-8xl pointer-events-none z-20 animate-iconJump animate-iconPulse"
